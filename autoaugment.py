...
class SubPolicy(object):
    def __init__(self,p1, operation1, magnitude_idx1, p2, operation2, magnitude_idx2,fillcolor=(128, 128, 128)):
        ...
        self.operation_name1=operation1
        self.operation_name2=operation2
    ...
    def __call__(self, img,  img2=None):
        if random.random() < self.p1: 
            if self.operation_name1=="sample_paring":
                img = self.operation1(img, img2, self.magnitude1)
            else:
                img = self.operation1(img, self.magnitude1)
        if random.random() < self.p2: 
            if self.operation_name2=="sample_paring":
                img = self.operation2(img, img2, self.magnitude2)
            else:
